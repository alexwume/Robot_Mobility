...
%
% Outputs:
% FP_pos: the position trajectory of the swing foot print
% FP_vel: the velocity trajectory of the swing foot print
% FP_acc: the acceleration trajectory of the swing foot print
